...
description: "Argyros runs on Fogo today, with Solana support coming soon."
llmDescription: "Argyros currently supports Fogo as the primary chain. Solana support with P-Token benefits (up to 7 hops, lower compute costs, better route optimization) is coming soon. Covers Fogo capabilities, the upcoming Solana chain parameter, and what to expect when Solana launches."
---
...
| Supported DEXs | Vortex, Fluxbeam, Fogo.fun |
...
| Supported DEXs | Vortex, Fluxbeam, Fogo.fun | Raydium, Orca, Meteora, Pump fun, Fluxbeam |
